...
try:
        ...
        #                 "SET num_of_occurrences = num_of_occurrences + 1 WHERE day = ? and language = ?")
        ...
        #                 "SET num_of_occurrences = num_of_occurrences + 1 WHERE day = ? and topic = ?")
        ...
        select_langs_prepared_query = session.prepare(\
                f"SELECT day, language, num_of_occurrences "\
        ...
        for i in range(min(len(langs_queried_rows_sorted), max_num_of_langs_to_show)):
                print(f"{langs_queried_rows_sorted[i].language}\t{langs_queried_rows_sorted[i].num_of_occurrences}")
        print()
        ...
        print("Check if the table(s) is (or are) sorted")
